        ...
        <div className="flex flex-wrap items-center justify-center gap-8">
          {technologies.map((tech) => (
            <div key={tech.name} className="flex flex-col items-center">
              <div className="radial-gradient-stack border-1 mb-4 flex size-12 items-center justify-center overflow-hidden rounded-full p-[13px] transition-transform hover:scale-110 hover:bg-neutral-900">
                <Image
